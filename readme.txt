=== Plugin Name ===
Plugin Name: Swoop: Password-Free Authentication for WordPress
Contributors: swoopbrandon
Tags: password, password free, magic link, magic message, authentication, passwordless, passwordless login, login shortcode, front end login, custom login form, admin login, temporary access, login security, security, brute force, 2 factor authentication, singup, conversion, 2FA, clef, email
Author: Swoop
...
The Swoop WordPress plugin is a simple and secure password-free authentication service. We invented the Magic Link™ and now the Magic Message™.

== Description ==

The Swoop WordPress plugin is a simple and secure password-free authentication service. We invented the Magic Link™ and now the Magic Message™. Imagine a world where your users are free to securely come and go from anywhere on your website without a password. We are passionate about the freedom that comes with eliminating passwords and believe you will be too once you download and install Swoop: Password-Free Authentication for WordPress.

**What is Swoop?**
Swoop: Password-Free Authentication for WordPress is a 3rd party service that calls out to the following [password free authentication service] (https://auth.swoop.email/). For more information on Swoops terms of service and privacy policy please visit our [legal page] (https://swoopnow.com/legal/).
...
How It Works:
Download, install and configure the plugin in about 5 minutes.
We automatically add the “Swoop In with email” button to your WP admin login page. This is great for internal/external access to administer your WordPress site. But don’t stop there …
Coming Soon: Add the “Swoop In with email” button anywhere you want with a short code.
You can also add the Swoop service to any call to action by following the instructions in our developer documentation.
The “Swoop In with email” button calls out to the Swoop authentication service to enable password-free access to your WordPress account and website.

Swoop’s authentication service offers two different first-time authorization options.

Magic Link: Swoop will email a Magic Link that provides security-packed password-free authentication.

[vimeo https://player.vimeo.com/video/412762435]

Magic Message: Similar to the Magic Link but with even fewer steps and no typing. Swoop users will send the magic authentication email instead of receiving an email with a Magic Link.
...
[http://swoopnow.com/images/screenshot1.png Swoop Service: Swoop In with email button used on WordPress Login]
[http://swoopnow.com/images/screenshot2.png Swoop Service: Magic Link or Magic Message authentication options]
[http://swoopnow.com/images/screenshot3.png Swoop Service: Quick Login authentication]
...
1. Use the Settings->Swoop: Password-Free Authentication for WordPress screen to configure the plugin.
